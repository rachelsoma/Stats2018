...
```
Given a correlation coefficient of 0.04 it is reasonable to say that there is not evidence of higher mean temperature correlating to earlier hard drve failure.
...
fit=lm(failed.meantemp ~ failed.days)
...
###Interpretation
Given a correlation coefficient of 0.04 and a p-value of close to zero from a paired t-test, it is reasonable to say that there is not evidence of higher mean temperature correlating to earlier hard drive failure.
