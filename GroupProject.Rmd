...
```{r}
# b=1000
# boot.meantemp = rep(NA, b)
# for (i in 1:b) {
#   boot.sample = sample(failed.meantemp,replace=TRUE)
#   boot.meantemp[i]=boot.sample
# }
# hist(boot.meantemp) #check histogram for normal distribution
# 
...
summary(lm(failed.meantemp ~ failed.days))
abline(test, col="blue", lwd=2)
...
#HA: The proportion of failed drives for at least 1 tested drive with differ from the others
